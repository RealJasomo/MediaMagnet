defmodule MediaMagnetWeb.CoreComponents do
  @moduledoc """
  ...
  def navbar(assigns) do
    ~H"""
    <div class="bg-slate-900 flex flex-col h-screen absolute top-0 left-0 px-5">
  ...
  def searchbox(assigns) do
    ~H"""
    <div class="relative flex-grow-1 w-3/6 mr-auto">
      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        <i class="fa-solid fa-magnifying-glass text-gray-500"></i>
      </div>
      <input
        type="text"
        class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 sm:text-sm"
        placeholder="Search"
      />
    </div>
    """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MediaMagnetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MediaMagnetWeb.Gettext, "errors", msg, opts)
    end
  end
